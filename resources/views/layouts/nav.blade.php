              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      <a class="dropdown-item" href="pages-account-settings-account.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">{{ auth()->user()->name ?? 'Name' }}</span>
                            <small class="text-muted">{{ auth()->user()->user_role ?? 'User Role' }}</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('admin.account.connections') }}">
                    ...
                    <li>
                      <a class="dropdown-item">
                        ...
                        @endphp
                        <small class="align-middle badge bg-dark">Version: {{ $version }}</small>
                      </a>
                    </li>
                  </ul>
                </li>
