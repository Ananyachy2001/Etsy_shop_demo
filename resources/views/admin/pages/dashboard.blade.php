...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="row">
    <div class="col-md-12">
      @if(isset($first_name) || isset($shop_name))
      <div class="alert alert-dark alert-dismissible fade show" style="background-color: #5f61e6 !important; color:white!important;" role="alert">
        <strong>Hi, {{ $first_name }}</strong> Your ETSY shop <b>"{{ $shop_name }}"</b> is integrated with this application.<br>
        <p>Listings Count: {{ $listing_count }}</p>
