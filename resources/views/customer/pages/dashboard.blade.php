      ...
      <div class="col-md-12 col-lg-4 mb-4">
        <div class="card">
          <div class="d-flex align-items-end row">
            <div class="col-8">
              <div class="card-body">
                <h6 class="card-title mb-1 text-nowrap">Congratulations {{ auth()->user()->name ?? 'Name' }}!</h6>
                ...
                <div class="report-list">
                  ...
                  <div class="report-list-item rounded-2 mb-3">
                    <div class="d-flex align-items-start">
                      <div class="report-list-icon shadow-sm me-2">
                        <img
                          src="../../assets/svg/icons/shopping-bag-icon.svg"
                          width="22"
                          height="22"
                          alt="Shopping Bag" />
                      </div>
              ...
              <tbody class="table-border-bottom-0">
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img
                        src="../../assets/img/icons/products/oneplus.png"
                        alt="Oneplus"
                        height="32"
                        width="32"
                        class="me-2" />
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img
                        src="../../assets/img/icons/products/magic-mouse.png"
                        alt="Apple"
                        height="32"
                        width="32"
                        class="me-2" />
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img
                        src="../../assets/img/icons/products/imac-pro.png"
                        alt="Apple"
                        height="32"
                        width="32"
                        class="me-2" />
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img
                        src="../../assets/img/icons/products/note10.png"
                        alt="Samsung"
                        height="32"
                        width="32"
                        class="me-2" />
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img
                        src="../../assets/img/icons/products/iphone.png"
                        alt="Apple"
                        height="32"
                        width="32"
                        class="me-2" />
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img
                        src="../../assets/img/icons/products/mi-tv.png"
                        alt="Xiaomi"
                        height="32"
                        width="32"
                        class="me-2" />
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center">
                      <img
                        src="../../assets/img/icons/products/logitech-mx.png"
                        alt="Logitech"
                        height="32"
                        width="32"
                        class="me-2" />
